...
**Автоматическая маршрутизация трафика через Tor для обеспечения приватности. Разработано специально для Debian 12 (Bookworm).**
...
graph TD
    ...
    Tor -->|Onion Network| Private[Защищенный ресурс]
